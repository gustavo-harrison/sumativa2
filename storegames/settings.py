"""
Django settings for storegames project.
...
SECRET_KEY = 'django-insecure-@tm=#h)5%+6g_w4^ue#s!d^a^4)o-&#(33d%*(2d*(p=w#__o@'
...
WSGI_APPLICATION = 'storegames.wsgi.application'
